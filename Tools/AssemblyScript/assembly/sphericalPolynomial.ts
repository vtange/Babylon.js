...
export class SphericalPolynomial {
     ...
     * @returns the spherical polynomial
     */
    public static FromArray(data: f64[][]): SphericalPolynomial {
...
export class SphericalHarmonics {
     ...
     */
    public addLight(direction: Vector3, color: Color3, deltaSolidAngle: f64): void {
        var colorVector = new Vector3(color.r, color.g, color.b);
     ...
     * @returns the spherical harmonics
     */
    public static FromArray(data: f64[][]): SphericalHarmonics {
