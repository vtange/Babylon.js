...
export class Color3 {
    ...
    */
     ...
     */
    public getHashCode(): u32 {
        let hash = <u32>this.r || 0;
        hash = (hash * 397) ^ (<u32>this.g || 0);
        hash = (hash * 397) ^ (<u32>this.b || 0);
        return hash;
    }
    ...
    */
    ...
    public equals(otherColor: Color3): bool {
        otherColor = otherColor || new Color3(1.1,1.1,1.1);
...
export class Color4 {
    ...
    public static CheckColors4(colors: f64[], count: i32): f64[] {
        ...
        if (colors.length === count * 3) {
            let colors4: f64[] = [];
            for (let index:i32 = 0; index < colors.length; index += 3) {
                let newIndex: i32 = (index / 3) * 4;
